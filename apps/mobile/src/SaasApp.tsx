...
const styles = StyleSheet.create({
  ...
  bubbleMeta: { color: theme.colors.muted, fontSize: 12 },
  ...
  conversationTime: { color: theme.colors.subtle, fontSize: 12 },
  ...
  retryText: { color: '#B42318', fontWeight: '900', fontSize: 12 },
