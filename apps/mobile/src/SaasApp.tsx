...
const styles = StyleSheet.create({
  ...
  orderSummaryLabel: { color: '#B54708', fontSize: 10, fontWeight: '900', letterSpacing: 0.5, marginTop: 2 },
  ...
  detailSummaryLabel: { color: theme.colors.muted, fontSize: 11, fontWeight: '800' },
  ...
  bubbleOrderRef: { color: theme.colors.greenDark, fontSize: 11, fontWeight: '900' },
  ...
  linkedOrderMeta: { color: theme.colors.muted, fontSize: 11, marginTop: 2 },
  ...
  conversationUnreadText: { color: theme.colors.white, fontSize: 9, fontWeight: '900' },
  ...
  notificationUnreadSummaryLabel: { color: theme.colors.slate, fontSize: 11, fontWeight: '800' },
  ...
  markAllReadText: { color: theme.colors.greenDark, fontSize: 11, fontWeight: '900' },
  ...
  notificationAlertTime: { color: theme.colors.subtle, fontSize: 11, marginTop: 4 },
