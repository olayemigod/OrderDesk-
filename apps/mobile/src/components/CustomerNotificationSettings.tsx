...
const styles = StyleSheet.create({
  ...
  readOnlyTitle: { color: '#344054', fontSize: 13, fontWeight: '900' },
  readOnlyText: { color: '#667085', fontSize: 13, lineHeight: 15, marginTop: 2 },
  ...
  toggleHelper: { color: '#667085', fontSize: 13, lineHeight: 18, marginTop: 2 },
  ...
  policyNote: { color: '#667085', fontSize: 13, lineHeight: 18 },
  error: { color: '#B42318', fontSize: 13, lineHeight: 16 },
  notice: { color: '#027A48', fontSize: 13, fontWeight: '800' },
  pressed: { opacity: 0.8 },
