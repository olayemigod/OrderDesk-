...
const styles = StyleSheet.create({
  ...
  headingCopy: { flex: 1 },
  eyebrow: { color: '#175CD3', fontSize: 8, fontWeight: '900', letterSpacing: 1 },
  title: { color: '#101828', fontSize: 14, fontWeight: '900', marginTop: 3 },
  text: { color: '#475467', fontSize: 10, lineHeight: 16, marginTop: 4 },
  error: { color: '#B42318', fontSize: 10, lineHeight: 15 },
  empty: { backgroundColor: '#FFFFFF', borderRadius: 10, padding: 11, gap: 3 },
  emptyTitle: { color: '#344054', fontSize: 11, fontWeight: '900' },
  emptyText: { color: '#667085', fontSize: 9, lineHeight: 14 },
  list: { gap: 10 },
  capture: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#EAECF0', borderRadius: 12, overflow: 'hidden' },
  ...
  placeholderText: { color: '#98A2B3', fontSize: 10, fontWeight: '800' },
  body: { padding: 11, gap: 5 },
  customer: { color: '#101828', fontSize: 11, fontWeight: '900' },
  caption: { color: '#475467', fontSize: 10, lineHeight: 15 },
  meta: { color: '#98A2B3', fontSize: 8 },
  reviewButton: { minHeight: 40, backgroundColor: '#246BFD', borderRadius: 9, alignItems: 'center', justifyContent: 'center', marginTop: 3 },
  reviewButtonText: { color: '#FFFFFF', fontSize: 10, fontWeight: '900' },
  refresh: { color: '#246BFD', fontSize: 10, fontWeight: '900' },
  disabled: { opacity: 0.45 },
  editor: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#84ADFF', borderRadius: 14, padding: 12, gap: 9 },
  editorTitle: { color: '#101828', fontSize: 14, fontWeight: '900' },
  editorImage: { width: '100%', height: 220, borderRadius: 11, backgroundColor: '#F2F4F7' },
  field: { gap: 6 },
  fieldLabel: { color: '#344054', fontSize: 11, fontWeight: '900' },
  help: { color: '#667085', fontSize: 9, lineHeight: 14 },
  ...
  dismissText: { color: '#B42318', fontWeight: '900', fontSize: 11 },
  ...
  primaryButton: { flex: 1, minHeight: 43, borderRadius: 10, backgroundColor: '#246BFD', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 8 },
