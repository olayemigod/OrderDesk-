...
const styles = StyleSheet.create({
  ...
  headingCopy: { flex: 1 },
  eyebrow: { color: '#079455', fontSize: 8, fontWeight: '900', letterSpacing: 1 },
  ...
  placeholderText: { color: '#667085', fontSize: 10, fontWeight: '800' },
  body: { padding: 11, gap: 5 },
  customer: { color: '#102A43', fontSize: 11, fontWeight: '900' },
  caption: { color: '#475467', fontSize: 10, lineHeight: 15 },
  meta: { color: '#667085', fontSize: 8 },
  ...
  refresh: { color: '#12B76A', fontSize: 10, fontWeight: '900' },
