...
const styles = StyleSheet.create({
  ...
  catalogueSummaryLabel: { color: '#667085', fontSize: 12, fontWeight: '900', letterSpacing: 0.3, marginTop: 2 },
  ...
  whatsappSummaryText: { color: '#475467', fontSize: 12, lineHeight: 14, marginTop: 3 },
  ...
  aliasLabel: { color: '#667085', fontSize: 12, fontWeight: '900', letterSpacing: 0.8, marginTop: 3 },
  ...
  stateText: { fontSize: 12, fontWeight: '900' },
  activeText: { color: '#027A48' },
  inactiveText: { color: '#667085' },
  link: { color: '#12B76A', fontSize: 12, fontWeight: '800' },
  ...
  emptyText: { color: '#667085', fontSize: 12, lineHeight: 17 },
  ...
  whatsappEyebrow: { color: '#027A48', fontSize: 12, fontWeight: '900', letterSpacing: 1 },
  whatsappTitle: { color: '#102A43', fontSize: 14, fontWeight: '900', marginTop: 3 },
  whatsappText: { color: '#475467', fontSize: 12, lineHeight: 16, marginTop: 4 },
  ...
  whatsappStatusText: { color: '#027A48', fontSize: 12, fontWeight: '900' },
  whatsappMeta: { color: '#475467', fontSize: 12, fontWeight: '700', flexShrink: 1 },
  whatsappForm: { gap: 9 },
  ...
  whatsappSaveButtonText: { color: '#FFFFFF', fontSize: 12, fontWeight: '900' },
  whatsappReadOnly: { color: '#667085', fontSize: 12, lineHeight: 15 },
