...
const styles = StyleSheet.create({
  ...
  catalogueSummaryCard: { flex: 1, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E4E7EC', borderRadius: 13, padding: 10, minWidth: 0 },
  catalogueSummaryValue: { color: '#102A43', fontSize: 18, fontWeight: '900' },
  catalogueSummaryLabel: { color: '#667085', fontSize: 7, fontWeight: '900', letterSpacing: 0.5, marginTop: 2 },
  searchInput: { minHeight: 44, borderWidth: 1, borderColor: '#D0D5DD', borderRadius: 12, backgroundColor: '#FFFFFF', paddingHorizontal: 12, color: '#102A43' },
  ...
  title: { color: '#102A43', fontSize: 21, fontWeight: '900', marginTop: 3 },
  ...
  itemIdentity: { flex: 1 },
  itemName: { color: '#102A43', fontSize: 14, fontWeight: '900' },
  itemMeta: { color: '#667085', fontSize: 10, marginTop: 2 },
  price: { color: '#102A43', fontSize: 13, fontWeight: '900' },
  aliasLabel: { color: '#667085', fontSize: 8, fontWeight: '900', letterSpacing: 0.9, marginTop: 3 },
