...
const styles = StyleSheet.create({
  ...
  summaryValue: { color: '#102A43', fontSize: 12, fontWeight: '900', flex: 1, textAlign: 'right' },
  ...
  attemptMeta: { color: '#667085', fontSize: 12, marginTop: 2 },
  time: { color: '#667085', fontSize: 12 },
  reference: { color: '#475467', fontSize: 12 },
  ...
  exceptionTitle: { color: '#B42318', fontSize: 12, fontWeight: '900' },
