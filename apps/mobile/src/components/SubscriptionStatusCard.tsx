...
export function SubscriptionStatusCard({ subscription, loading, error }: Props) {
  ...
  return (
    <View style={[styles.card, readOnly && styles.blockedCard]}>
      ...
      {subscription.priceAmount === null ? (
        <Text style={styles.helper}>Commercial checkout pricing will be activated in the billing-provider slice.</Text>
      ) : (
