...
const styles = StyleSheet.create({
  ...
  helper: { color: '#667085', fontSize: 13, lineHeight: 15, marginTop: 3 },
  ...
  orderRef: { color: '#102A43', fontSize: 13, fontWeight: '900' },
  customer: { color: '#667085', fontSize: 13, marginTop: 2 },
  metaRow: { flexDirection: 'row', justifyContent: 'space-between', gap: 10 },
  method: { color: '#475467', fontSize: 13, fontWeight: '800' },
  amount: { color: '#102A43', fontSize: 13, fontWeight: '900' },
  claim: { color: '#B54708', fontSize: 13, fontWeight: '800' },
  reference: { color: '#667085', fontSize: 13 },
  time: { color: '#667085', fontSize: 13 },
  error: { color: '#B42318', fontSize: 13, lineHeight: 15 },
  exception: { color: '#B42318', fontSize: 13, lineHeight: 15, fontWeight: '800' },
