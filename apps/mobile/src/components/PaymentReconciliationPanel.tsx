...
const styles = StyleSheet.create({
  wrap: { gap: 10, borderTopWidth: 1, borderTopColor: '#EAECF0', paddingTop: 15 },
  ...
  helper: { color: '#667085', fontSize: 10, lineHeight: 15, marginTop: 3 },
  ...
  metricValue: { color: '#101828', fontSize: 15, fontWeight: '900' },
  metricValueAttention: { color: '#B54708' },
  metricLabel: { color: '#667085', fontSize: 8, fontWeight: '800', marginTop: 2 },
  ...
  filterButtonActive: { backgroundColor: '#101828', borderColor: '#101828' },
  filterText: { color: '#475467', fontSize: 9, fontWeight: '900' },
  filterTextActive: { color: '#FFFFFF' },
  empty: { backgroundColor: '#F9FAFB', borderRadius: 12, padding: 12 },
  emptyTitle: { color: '#344054', fontSize: 11, fontWeight: '900' },
  item: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#EAECF0', borderRadius: 12, padding: 11, gap: 6 },
  itemTop: { flexDirection: 'row', gap: 10, alignItems: 'flex-start' },
  orderRef: { color: '#101828', fontSize: 12, fontWeight: '900' },
  customer: { color: '#667085', fontSize: 10, marginTop: 2 },
  metaRow: { flexDirection: 'row', justifyContent: 'space-between', gap: 10 },
  method: { color: '#475467', fontSize: 10, fontWeight: '800' },
  amount: { color: '#101828', fontSize: 10, fontWeight: '900' },
  ...
  pillText: { color: '#475467', fontSize: 8, fontWeight: '900' },
  pillTextPositive: { color: '#027A48' },
  pillTextAttention: { color: '#B54708' },
  actions: { flexDirection: 'row', gap: 7, flexWrap: 'wrap' },
  primaryButton: { minHeight: 38, flexGrow: 1, borderRadius: 9, backgroundColor: '#246BFD', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 10 },
  ...
  secondaryText: { color: '#344054', fontSize: 9, fontWeight: '900' },
