...
const styles = StyleSheet.create({
  ...
  title: { color: '#101828', fontSize: 24, fontWeight: '900', marginTop: 3 },
  ...
  metricValue: { color: '#101828', fontSize: 20, fontWeight: '900' },
  metricLabel: { color: '#667085', fontSize: 9, fontWeight: '800', marginTop: 2 },
  search: { minHeight: 44, borderWidth: 1, borderColor: '#D0D5DD', borderRadius: 12, backgroundColor: '#FFFFFF', paddingHorizontal: 12, color: '#101828' },
  list: { gap: 8 },
  customerCard: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#EAECF0', borderRadius: 14, padding: 12, gap: 4 },
  customerCardSelected: { borderColor: '#246BFD', backgroundColor: '#F7F9FF' },
  customerTop: { flexDirection: 'row', justifyContent: 'space-between', gap: 10 },
  customerCopy: { flex: 1 },
  customerName: { color: '#101828', fontSize: 13, fontWeight: '900' },
  meta: { color: '#667085', fontSize: 9, lineHeight: 14, marginTop: 2 },
  orderCount: { color: '#175CD3', fontSize: 9, fontWeight: '900' },
  value: { color: '#344054', fontSize: 10, fontWeight: '800', marginTop: 4 },
  detailCard: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#EAECF0', borderRadius: 16, padding: 14, gap: 9 },
  sectionTitle: { color: '#101828', fontSize: 13, fontWeight: '900', marginTop: 3 },
  identityLabel: { color: '#667085', fontSize: 9, fontWeight: '900' },
  identityValue: { color: '#101828', fontSize: 11, fontWeight: '800' },
  identityHelp: { color: '#98A2B3', fontSize: 9, lineHeight: 14 },
  fieldLabel: { color: '#344054', fontSize: 9, fontWeight: '900', marginTop: 4 },
  input: { minHeight: 44, borderWidth: 1, borderColor: '#D0D5DD', borderRadius: 11, paddingHorizontal: 12, color: '#101828', backgroundColor: '#FFFFFF' },
  primary: { minHeight: 43, borderRadius: 10, backgroundColor: '#246BFD', alignItems: 'center', justifyContent: 'center' },
  primaryText: { color: '#FFFFFF', fontSize: 10, fontWeight: '900' },
  orderRow: { flexDirection: 'row', justifyContent: 'space-between', gap: 10, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: '#EAECF0', paddingTop: 8 },
  orderRef: { color: '#101828', fontSize: 10, fontWeight: '900' },
  ...
  emptyTitle: { color: '#101828', fontSize: 12, fontWeight: '900' },
