...
const styles = StyleSheet.create({
  ...
  helper: { color: '#667085', fontSize: 12, lineHeight: 15 },
  list: { gap: 8 },
  ...
  eventCopy: { flex: 1 },
  eventTitle: { color: '#102A43', fontSize: 13, fontWeight: '900' },
  ...
  statusText: { color: '#475467', fontSize: 12, fontWeight: '900' },
  statusTextPositive: { color: '#027A48' },
  statusTextAttention: { color: '#B54708' },
  message: { color: '#475467', fontSize: 12, lineHeight: 16 },
  attentionText: { color: '#B54708', fontSize: 12, lineHeight: 14 },
  emptyCard: { backgroundColor: '#F9FAFB', borderRadius: 12, padding: 12 },
  emptyTitle: { color: '#344054', fontSize: 13, fontWeight: '800' },
  emptyText: { color: '#667085', fontSize: 12, lineHeight: 15, marginTop: 3 },
});
