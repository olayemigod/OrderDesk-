...
const styles = StyleSheet.create({
  ...
  valueLabel: { color: '#079455', fontSize: 12, fontWeight: '900', letterSpacing: 1 },
  ...
  comparison: { color: '#079455', fontSize: 12, lineHeight: 15, fontWeight: '700', marginTop: 7 },
  ...
  rankText: { color: '#079455', fontSize: 12, fontWeight: '900' },
  topItemCopy: { flex: 1 },
  topItemName: { color: '#102A43', fontSize: 13, fontWeight: '800' },
  topItemMeta: { color: '#667085', fontSize: 12, marginTop: 2 },
  topItemValue: { color: '#344054', fontSize: 12, fontWeight: '900' },
  staffNote: { backgroundColor: '#F9FAFB', borderRadius: 12, padding: 11 },
  staffTitle: { color: '#344054', fontSize: 12, fontWeight: '900' },
  staleText: { color: '#B54708', fontSize: 12, lineHeight: 14 },
  ...
  errorText: { color: '#912018', fontSize: 12, lineHeight: 15 },
  retry: { color: '#B42318', fontSize: 12, fontWeight: '900', marginTop: 3 },
});
