...
const styles = StyleSheet.create({
  ...
  welcomeHero: { gap: 8 },
  welcomeEyebrow: { color: '#6CE9A6', fontSize: 13, fontWeight: '900', letterSpacing: 1.3 },
  ...
  welcomeBenefitText: { color: '#D0D5DD', fontSize: 13, lineHeight: 18, marginTop: 2 },
  ...
  eyebrow: { color: '#12B76A', fontSize: 13, fontWeight: '800', letterSpacing: 1.4 },
  ...
  fieldHint: { color: '#667085', fontSize: 13, lineHeight: 18 },
  fieldAction: { minHeight: 32, minWidth: 46, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 8 },
  fieldActionText: { color: '#12B76A', fontSize: 13, fontWeight: '900' },
  ...
  signInHelpText: { color: '#667085', fontSize: 13, lineHeight: 18, textAlign: 'center' },
  ...
  supportActionText: { color: '#079455', fontSize: 13, fontWeight: '900' },
  ...
  legalConsentText: { flex: 1, color: '#667085', fontSize: 13, lineHeight: 18 },
