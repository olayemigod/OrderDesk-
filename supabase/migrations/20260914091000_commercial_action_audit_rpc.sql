-- Owner/Manager read model for the idempotent commercial action ledger.

create or replace function public.sellertray_list_commercial_actions(
  p_tenant_id uuid,
...
begin
  ...
  return query
  select
    a.id,a.created_at,a.action_type,a.risk_class,a.requested_by,
    ...
    o.public_order_id,a.channel,a.metadata
...
revoke all on function public.sellertray_list_commercial_actions(uuid,integer) from public,anon;
