...
-- This is the source schema for the first vertical slice. It has not yet been applied
...
create table public.orders (
  ...
  source_message_id uuid references public.inbound_messages(id) on delete set null,
